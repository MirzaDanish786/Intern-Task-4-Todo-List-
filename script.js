...
// // Code of Todo App without using local storage:

// // Add todo when press the enter button:
// addTodo_Input.addEventListener("keypress",(e)=>{
//   if(e.key === 'Enter'){
//     let todoText = addTodo_Input.value.trim();
//     if (todoText != "") {
...
//     const todoLayout = ` <div class="items">
//                     <div class="todoText">
//                         ${todo}
//                     </div>
...
//       let editBtn = document.querySelector(`.editBtn[data-index="${index}"]`)
...
// Code of Todo App using Local Storage:
